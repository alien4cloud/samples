...
SELECT setval('vets_seq', (SELECT MAX(id) FROM vets)+1);
...
SELECT setval('specialties_seq', (SELECT MAX(id) FROM specialties)+1);
...
SELECT setval('types_seq', (SELECT MAX(id) FROM types)+1);
...
SELECT setval('owners_seq', (SELECT MAX(id) FROM owners)+1);
...
SELECT setval('pets_seq', (SELECT MAX(id) FROM pets)+1);
...
SELECT setval('visits_seq', (SELECT MAX(id) FROM visits)+1);