...
println "warHostedOnTomcat_post_configure_source<${SOURCE}>: Target: ${TARGET_NAME}/${TARGET}:${tomcatIp}, Source: ${SOURCE_NAME}/${SOURCE}, warUrl is ${warUrl} and contextPath is ${contextPath}..."
